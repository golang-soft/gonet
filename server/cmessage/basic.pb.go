...
type GameData struct {
	...
	Part1Score           int64    `protobuf:"varint,6,opt,name=part1Score,proto3" json:"part1Score,omitempty"`
	...
	Part2Score           int64    `protobuf:"varint,9,opt,name=part2Score,proto3" json:"part2Score,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GameData) GetPart1Score() int64 {
	if m != nil {
		return m.Part1Score
	}
	return 0
...
func (m *GameData) GetPart2Score() int64 {
	if m != nil {
		return m.Part2Score
	}
	return 0
...
func (m *UserData) GetRound() int64 {
	if m != nil {
		return m.Round
	}
	return 0
...
var fileDescriptor_0cc45f6ac745dd88 = []byte{
	...
	,
}
